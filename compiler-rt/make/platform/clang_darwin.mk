...
Configs += cc_kext
#UnivergalArchs.cc_kext := $(call CheckArches,armv7 i386 x86_64,cc_kext)
UniversalArchs.cc_kext := armv7
...
CFLAGS := -target arm-apple-darwin11 -Wall -Werror -O3 -fomit-frame-pointer
